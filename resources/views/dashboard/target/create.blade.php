...
@section('content')
    <div class="container grid px-6 py-6 mx-auto">
        ...
        <form action="{{ route('target.store') }}" method="post" class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
            @csrf
        ...
        <form action="{{ route('target.store') }}" method="post" class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md"
            ...
            <div class="flex w-full gap-4">
                <label class="block w-full px-6 text-sm">
                    ...
                    <p class="w-full text-sm text-gray-700 whitespace-normal">
                        Header
                    <ol class="grid w-full grid-cols-6 text-gray-500 list-decimal">
                        <li>id_outlet</li>
                        <li>trx</li>
                        <li>rev</li>
                        <li>jenis</li>
